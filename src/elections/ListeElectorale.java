...
public class ListeElectorale {
	...
	public void setNom(String nom) throws ElectionsException{
		if(nom.isEmpty()) throw new ElectionsException("Veuillez introduire une chaine de caractère pour le nom");
		this.nom = nom;
	}
	...
	public void setVoix(int voix) throws ElectionsException {
		if(voix < 0) throw new ElectionsException("Le # de voix doit etre >= 0");
		this.voix = voix;
	}
	...
	public void setSieges(int sieges) throws ElectionsException{
		if (sieges < 0) throw new ElectionsException("Le # de sieges doit etre >= 0");
		this.sieges = sieges;
	}
